...
class MLToolMixin:
    ...
    def __init__(self, settings_file, working_location):
        ...
        self.hp_use_batch_normalization = 0
        self.hp_use_dropout = 0
