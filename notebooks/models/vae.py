# Code originaly from
# https://github.com/davidADSP/GDL_code/blob/master/models/VAE.py
# But modified and added to.
...
class DenseVariationalAutoencoder():
    def __init__(self,
        ...
        self.name = 'dense_variational_autoencoder'

        self.input_dim = input_dim
        self.encoder_layer_sizes = encoder_layer_sizes
        self.decoder_layer_sizes = decoder_layer_sizes
        self.z_dim = z_dim
        self.non_linear_activation_bool = non_linear_activation_bool
    ...
    def _build(self):
        ...
        for i, j in enumerate(self.encoder_layer_sizes):
            x = Dense(j)(x)

            if self.use_batch_norm:
                x = BatchNormalization()(x)

            if self.non_linear_activation_bool:
                x = LeakyReLU()(x)
